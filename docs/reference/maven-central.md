---
title: Maven Central
description: Firefly 1.0.1 的 Maven Central 坐标、模块依赖链和版本策略。
---

# Maven Central

Firefly `1.0.1` 已通过 `io.github.fishered` 命名空间发布到 Maven Central。Spring Boot 业务项目只需要引入一个 Starter，无需添加私有仓库或单独声明 Firefly 的内部模块。

[在 Maven Central 查看 firefly-spring-boot-starter 1.0.1](https://central.sonatype.com/artifact/io.github.fishered/firefly-spring-boot-starter/1.0.1)
