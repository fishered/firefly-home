---
title: Maven Central
description: Firefly 1.1.3 的 Maven Central 坐标、模块依赖链和版本策略。
---
...
[在 Maven Central 查看 firefly-spring-boot-starter 1.1.3](https://central.sonatype.com/artifact/io.github.fishered/firefly-spring-boot-starter/1.1.3)
