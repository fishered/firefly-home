...
| 版本 | 发布日期 | 本版本特性 |
|---|---|---|
| [v1.1.3](./v1.1.3.md) | 2026-09-03 | 业务时间窗口、数据就绪条件、事件防抖聚合、可恢复补数、执行重放、资源感知调度和 SLA 预算 |
| [v1.1.2](./v1.1.2.md) | 2026-09-01 | 多模块工程结构、批处理切分基础、依赖条件门控和生产部署版本一致性 |
| [v1.1.1](./v1.1.1.md) | 2026-08-30 | 调度语义与业务日历基础、事件幂等与批处理结果接线、Admin 日历多选、JDBC 日历与导入批次增量迁移 |
