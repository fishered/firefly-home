...
The `v1.0.4` source tag and Maven Central artifacts have not been published yet. Before upgrading production dependencies, confirm that `1.0.4` is indexed in [Central Portal](https://central.sonatype.com/artifact/io.github.fishered/firefly-spring-boot-starter).
:::
