...
The `v1.0.6` source tag and Maven Central artifacts were published on August 9, 2026. See the [source tag](https://github.com/fishered/Firefly/tree/v1.0.6) and [Central Portal](https://central.sonatype.com/artifact/io.github.fishered/firefly-spring-boot-starter/1.0.6).
:::
