...
Version `1.1.3` is available from [Maven Central](https://central.sonatype.com/artifact/io.github.fishered/firefly-spring-boot-starter/1.1.3), with no additional repository required.
