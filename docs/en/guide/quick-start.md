...
::: tip Firefly 1.1.1
`1.1.1` has been uploaded to [Maven Central](https://central.sonatype.com/artifact/io.github.fishered/firefly-spring-boot-starter/1.1.1) through the tag-driven release workflow.
:::
