...
::: tip Firefly 1.0.8
`1.0.8` has been uploaded to [Maven Central](https://central.sonatype.com/artifact/io.github.fishered/firefly-spring-boot-starter/1.0.8) through the tag-driven release workflow.
:::
